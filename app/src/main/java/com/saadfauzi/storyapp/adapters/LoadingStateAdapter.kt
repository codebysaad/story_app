...
import com.saadfauzi.storyapp.databinding.ItemLoadingLayoutBinding
...
class LoadingStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<LoadingStateAdapter.LoadingStateViewHolder>() {
    ...
    class LoadingStateViewHolder(private val binding: ItemLoadingLayoutBinding, retry: () -> Unit) :
